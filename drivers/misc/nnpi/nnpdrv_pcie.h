...
#if ((LINUX_VERSION_CODE > KERNEL_VERSION(3, 15, 0)) && /* SPH_IGNORE_STYLE_CHECK */ \
     (LINUX_VERSION_CODE < KERNEL_VERSION(4, 13, 0))) /* SPH_IGNORE_STYLE_CHECK */
#define NNP_PCIE_HAVE_RESET_NOTIFY
#elif (LINUX_VERSION_CODE > KERNEL_VERSION(4, 12, 0)) /* SPH_IGNORE_STYLE_CHECK */
#define NNP_PCIE_HAVE_RESET_PREPARE
#endif
