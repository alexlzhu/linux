...
typedef struct nnpdrv_host_resource *hostres_handle; /**< handle to host resource */ /* SPH_IGNORE_STYLE_CHECK */
 ...
 */
int nnpdrv_hostres_create(size_t size, enum dma_data_direction dir, hostres_handle *res);
 ...
 * @return error number on failure.
 */
int nnpdrv_hostres_dma_buf_create(int dma_buf_fd, enum dma_data_direction dir, hostres_handle *res);
 ...
 */
bool nnpdrv_hostres_destroy(hostres_handle res);
 ...
 * @return error on failure.
 */
int nnpdrv_hostres_unmap_device(hostres_handle res, struct nnp_device *nnpdev);
 ...
 * @return error on failure.
 */
int nnpdrv_hostres_map_user(hostres_handle res, struct vm_area_struct *vma);
 ...
 * @return error on failure.
 */
int nnpdrv_hostres_dev_lock(hostres_handle res, struct nnp_device *nnpdev, enum dma_data_direction dir);
 ...
 * @return error on failure.
 */
int nnpdrv_hostres_dev_unlock(hostres_handle res, struct nnp_device *nnpdev, enum dma_data_direction dir);
 ...
 * @return error on failure.
 */
int nnpdrv_hostres_user_lock(hostres_handle res, unsigned int timeout);
 ...
 * @return error on failure.
 */
int nnpdrv_hostres_user_unlock(hostres_handle res);
 ...
 * @param[in]  res  handle to the host resource
 */
void nnpdrv_hostres_get(hostres_handle res);
 ...
 */
bool nnpdrv_hostres_put(hostres_handle res);
 ...
 */
bool nnpdrv_hostres_is_input(hostres_handle res);
 ...
 */
bool nnpdrv_hostres_is_output(hostres_handle res);
