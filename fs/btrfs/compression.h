...
struct list_head *btrfs_get_workspace(enum btrfs_compression_type type,
				      unsigned int level);
void btrfs_put_workspace(enum btrfs_compression_type type,
			 struct list_head *ws);

struct btrfs_compress_op {
	struct workspace_manager *workspace_manager;
	/* Minimum level supported by the compression algorithm */
	int min_level;
	/* Maximum level supported by the compression algorithm */
	int max_level;
	/* Default level supported by the comrpession algorithm */
	int default_level;
};
